        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                   <?php
                    $sql = mysqli_query($con, "SELECT * FROM users LIMIT 4");
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="includes/manage_users.php?act=delete&id=<?php echo $data['user_id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-remove"> Remove</i></a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
